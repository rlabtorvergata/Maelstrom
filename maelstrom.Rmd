...
{if (input$layerType1 == "Dropout") {cat("Layer n° 1 is a", input$layerType1, "layer, with a", input$dropout1, "dropout value.", "\n\n")} else
  {cat("Layer n° 1 is a", input$layerType1, "layer, with", input$neurons1, "neurons and a", input$activation, "activation funcion.", "\n\n")}}
if (input$layerType2 != "")
{if (input$layerType2 == "Dropout") {cat("Layer n° 2 is a", input$layerType2, "layer, with a", input$dropout2, "dropout value.", "\n\n")} else
  {cat("Layer n° 2 is a", input$layerType2, "layer, with", input$neurons2, "neurons and a", input$activation, "activation funcion.", "\n\n")}}
if (input$layerType3 != "")
{if (input$layerType3 == "Dropout") {cat("Layer n° 3 is a", input$layerType3, "layer, with a", input$dropout3, "dropout value.", "\n\n")} else
  {cat("Layer n° 3 is a", input$layerType3, "layer, with", input$neurons3, "neurons and a", input$activation, "activation funcion.", "\n\n")}}
if (input$layerType4 != "")
{if (input$layerType4 == "Dropout") {cat("Layer n° 4 is a", input$layerType4, "layer, with a", input$dropout4, "dropout value.", "\n\n")} else
  {cat("Layer n° 4 is a", input$layerType4, "layer, with", input$neurons4, "neurons and a", input$activation, "activation funcion.", "\n\n")}}
if (input$layerType5 != "")
{if (input$layerType5 == "Dropout") {cat("Layer n° 5 is a", input$layerType5, "layer, with a", input$dropout5, "dropout value.", "\n\n")} else
  {cat("Layer n° 5 is a", input$layerType5, "layer, with", input$neurons5, "neurons and a", input$activation, "activation funcion.", "\n\n")}}
